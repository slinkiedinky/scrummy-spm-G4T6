...
function ProjectsPage() {
    ...
    async function load() {
        try {
            setLoading(true);
            setError(null);
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["listProjects"])(); // GET /api/projects/
            setProjectsRaw(data);
...
_s(ProjectsPage, "bRrZD9Vqu5hXIATwVooN6qOQ+Ww=");
_c = ProjectsPage;
var _c;
...
//# sourceMappingURL=src_7ddc331b._.js.map