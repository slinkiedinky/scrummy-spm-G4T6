...
"[project]/src/app/(dashboard)/projects/[id]/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const createEmptyTaskForm = function() {
    let uid = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "";
    return {
        title: "",
        description: "",
        assigneeId: uid,
...
function ProjectDetailPage() {
    ...
    const [taskForm, setTaskForm] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "ProjectDetailPage.useState": ()=>createEmptyTaskForm()
    }["ProjectDetailPage.useState"]);
        ...
        "ProjectDetailPage.useCallback[load]": async (userId)=>{
            ...
            try {
                ...
                const [p, t, u] = await Promise.all([
                    ...
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["listUsers"])()
                ]);
                setProject(p);
                setTasks(t);
    ...
    const resetTaskForm = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ProjectDetailPage.useCallback[resetTaskForm]": ()=>{
            ...
            setTaskForm(createEmptyTaskForm((_currentUser_uid = currentUser === null || currentUser === void 0 ? void 0 : currentUser.uid) !== null && _currentUser_uid !== void 0 ? _currentUser_uid : ""));
        }
    }["ProjectDetailPage.useCallback[resetTaskForm]"], [
        currentUser === null || currentUser === void 0 ? void 0 : currentUser.uid
    ]);
    ...
    const handleTaskDialogChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ProjectDetailPage.useCallback[handleTaskDialogChange]": (open)=>{
    ...
    }["ProjectDetailPage.useCallback[handleTaskDialogChange]"], [
        resetTaskForm
    ]);
    ...
    const ownerId = (project === null || project === void 0 ? void 0 : project.ownerId) || (project === null || project === void 0 ? void 0 : project.createdBy) || "";
    const userLookup = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProjectDetailPage.useMemo[userLookup]": ()=>{
            const map = new Map();
            users.forEach({
                "ProjectDetailPage.useMemo[userLookup]": (user)=>{
    ...
    const teamMembers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProjectDetailPage.useMemo[teamMembers]": ()=>{
            const ids = Array.isArray(project === null || project === void 0 ? void 0 : project.teamIds) ? [
                ...project.teamIds
            ] : [];
            ...
            const seen = new Set();
            return ids.map({
                "ProjectDetailPage.useMemo[teamMembers]": (raw)=>(typeof raw === "string" ? raw.trim() : String(raw !== null && raw !== void 0 ? raw : "")).trim()
            }["ProjectDetailPage.useMemo[teamMembers]"]).filter({
                "ProjectDetailPage.useMemo[teamMembers]": (id)=>{
                    if (!id) return false;
                    if (seen.has(id)) return false;
                    seen.add(id);
                    return true;
                }
            }["ProjectDetailPage.useMemo[teamMembers]"]).map({
                "ProjectDetailPage.useMemo[teamMembers]": (id)=>{
                    const info = userLookup.get(id);
                    const fullName = ((info === null || info === void 0 ? void 0 : info.fullName) || (info === null || info === void 0 ? void 0 : info.displayName) || (info === null || info === void 0 ? void 0 : info.name) || "").trim();
                    const email = ((info === null || info === void 0 ? void 0 : info.email) || "").trim();
                    const role = typeof (info === null || info === void 0 ? void 0 : info.role) === "string" ? info.role.trim() : "";
                    return {
                        id,
                        fullName,
                        email,
                        ...
                        isCurrentUser: id === ((currentUser === null || currentUser === void 0 ? void 0 : currentUser.uid) || "")
                    };
                }
            }["ProjectDetailPage.useMemo[teamMembers]"]);
        }
    }["ProjectDetailPage.useMemo[teamMembers]"], [
        project === null || project === void 0 ? void 0 : project.teamIds,
        userLookup,
        ownerId,
        currentUser === null || currentUser === void 0 ? void 0 : currentUser.uid
    ]);
    const availableUsers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProjectDetailPage.useMemo[availableUsers]": ()=>{
            const teamSet = new Set(teamMembers.map({
                "ProjectDetailPage.useMemo[availableUsers]": (member)=>member.id
            }["ProjectDetailPage.useMemo[availableUsers]"]));
            return users.filter({
                "ProjectDetailPage.useMemo[availableUsers]": (user)=>(user === null || user === void 0 ? void 0 : user.id) && !teamSet.has(user.id)
            }["ProjectDetailPage.useMemo[availableUsers]"]).map({
                "ProjectDetailPage.useMemo[availableUsers]": (user)=>({
                        id: user.id,
                        label: (user.fullName || user.displayName || user.name || "").trim() || (user.email || "").trim() || user.id,
                        email: (user.email || "").trim()
                    })
            }["ProjectDetailPage.useMemo[availableUsers]"]).sort({
                "ProjectDetailPage.useMemo[availableUsers]": (a, b)=>a.label.localeCompare(b.label)
            }["ProjectDetailPage.useMemo[availableUsers]"]);
        }
    }["ProjectDetailPage.useMemo[availableUsers]"], [
        users,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProjectDetailPage.useEffect": ()=>{
            if (selectedMember && !availableUsers.some({
                "ProjectDetailPage.useEffect": (user)=>user.id === selectedMember
            }["ProjectDetailPage.useEffect"])) {
                setSelectedMember("");
            }
        }
    ...
    async function handleAddMember() {
        ...
        try {
            ...
            var _error_message;
            setMemberError((_error_message = error === null || error === void 0 ? void 0 : error.message) !== null && _error_message !== void 0 ? _error_message : "Failed to add member.");
        } finally{
    ...
    if (userLoading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            fileName: "[project]/src/app/(dashboard)/projects/[id]/page.jsx",
            lineNumber: 337,
            columnNumber: 7
        }, this);
    }
    ...
    if (err || !project) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "flex h-full items-center justify-center p-6 text-destructive",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogHeader"], {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogDescription"], {
                                        children: "Provide details for the new task. You can adjust them later."
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/(dashboard)/projects/[id]/page.jsx",
                                        lineNumber: 366,
                                        columnNumber: 15
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                        className: "not-print w-full max-w-xs space-y-3 p-4",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "space-y-1",
                                                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                className: "p-4 space-y-4 not-print",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        ...
                                                        children: "Invite collaborators to work on this project."
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/(dashboard)/projects/[id]/page.jsx",
                                                        lineNumber: 522,
                                                        columnNumber: 17
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Select"], {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectContent"], {
                                                                children: availableUsers.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectItem"], {
                                                                    value: "",
                                                                    disabled: true,
                                                                    children: "No users to add"
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/app/(dashboard)/projects/[id]/page.jsx",
                                                                    lineNumber: 539,
                                                                    columnNumber: 23
                                                                }, this) : availableUsers.map((user)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectItem"], {
                                                                        value: user.id,
                                                                        children: "".concat(user.label).concat(user.email && user.email !== user.label ? " (".concat(user.email, ")") : "")
                                                                    }, user.id, false, {
                                                                        fileName: "[project]/src/app/(dashboard)/projects/[id]/page.jsx",
                                                                        lineNumber: 544,
                                                                        columnNumber: 25
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                        ...
                                                        children: addingMember ? "Adding..." : "Add"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/(dashboard)/projects/[id]/page.jsx",
                                                        lineNumber: 553,
                                                        columnNumber: 17
                                    ...
                                    memberError && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "flex items-center gap-2 rounded-md border border-destructive/50 bg-destructive/10 px-3 py-2 text-sm text-destructive",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$circle$2d$alert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__AlertCircle$3e$__["AlertCircle"], {
                                                className: "h-4 w-4"
                                    ...
                                    teamMembers.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: teamMembers.map((member)=>{
                                            ...
                                            const secondary = member.email && member.email !== displayName ? member.email : member.id !== displayName ? member.id : "";
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    secondary && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    member.isCurrentUser && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$badge$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                                                                        variant: "secondary",
                                                                        children: "You"
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/src/app/(dashboard)/projects/[id]/page.jsx",
                                                                    ...
                                                                    member.isOwner && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$badge$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                                                                        variant: "outline",
                                                                        children: "Owner"
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/src/app/(dashboard)/projects/[id]/page.jsx",
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Select"], {
                                                                ...
                                                                onValueChange: (value)=>handleTaskStatus(t.id, value),
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectTrigger"], {
                                                                        className: "w-[160px]",
                                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectValue"], {
...
_s(ProjectDetailPage, "WBJMg7s5iUy7Lb9mvjjBtJkf1wQ=", false, function() {
    return [
...
//# sourceMappingURL=src_c36711f7._.js.map