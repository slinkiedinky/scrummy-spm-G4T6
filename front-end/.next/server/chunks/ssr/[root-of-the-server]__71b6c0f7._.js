...
function ProjectsPage() {
    ...
    async function load() {
        try {
            setLoading(true);
            setError(null);
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["listProjects"])(); // GET /api/projects/
            setProjectsRaw(data);
    ...
    const filteredAndSortedProjects = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        const filtered = projects.filter((p)=>{
            ...
            const matchesEmployee = !employeeFilter || p.teamIds?.some((m)=>(m?.name ?? "").toLowerCase().includes(employeeFilter.toLowerCase()));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__71b6c0f7._.js.map